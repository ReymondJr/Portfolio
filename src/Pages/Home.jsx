...
const WORDS = ["Futuro Ingeniero en Software", "Amante de la Tecnología"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Css", "Html", "PHP-Laravel", "MySQL", "Java", "Csharp"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Reymondjr" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/reymodjradames/" },
  { icon: Instagram, link: "https://www.instagram.com/reymond_j.a" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                 Creación de sitios web innovadores, funcionales y fáciles de usar para soluciones digitales.
                </p>
